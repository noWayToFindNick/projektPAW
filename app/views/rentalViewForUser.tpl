...
{block name=offer}
    <section id="features" class="container special">
        ...
        <div id="userTableReload">
            {include file="userRentalsTable.tpl"}
        </div>
    </section>
{/block}

{block name=filtering}
    <form id="filterForm" class="rentForm" onsubmit="ajaxPostForm('filterForm','{$conf->action_root}rentalsOnlyUser','userTableReload'); return false;">
        <select name="filter">
